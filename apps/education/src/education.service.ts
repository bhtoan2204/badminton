...
export class EducationService {
  ...
  async updateDetailEducationProgress(id_user: string, dto: any) {
    try {
      const { id_education_progress, id_family, title, progress_notes, school_info } = dto;
      const query = 'SELECT * FROM f_update_education_progress($1, $2, $3, $4, $5, $6)';
      const params = [id_user, id_education_progress, id_family, title, progress_notes, school_info];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
        data: data
  ...
  async updateDetailSubject(id_user: string, dto: any) {
    try {
      const { id_subject, id_education_progress, id_family, subject_name, description } = dto;
      const query = 'SELECT * FROM f_update_subject($1, $2, $3, $4, $5, $6)';
      const params = [id_user, id_subject, id_education_progress, id_family, subject_name, description];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
        data: data
  ...
  async addComponentScore(id_user: string, dto: any) {
    const { id_subject, id_education_progress, id_family, component_name, score } = dto;
    try {
      const query = 'SELECT * FROM f_add_component_score($1, $2, $3, $4, $5, $6)';
      const params = [id_user, id_subject, id_education_progress, id_family, component_name, score];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
  ...
  async insertComponentScore(id_user: string, dto: any) {
    const { id_subject, id_education_progress, id_family, component_name, score, index } = dto;
    try {
      const query = 'SELECT * FROM f_insert_component_score($1, $2, $3, $4, $5, $6, $7)';
      const params = [id_user, id_subject, id_education_progress, id_family, component_name, score, index];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
  ...
  async updateComponentScore(id_user: string, dto: any) {
    const { index, id_subject, id_education_progress, id_family, component_name, score } = dto;
    try {
      const query = 'SELECT * FROM f_update_component_score($1, $2, $3, $4, $5, $6, $7)';
      const params = [id_user, id_subject, id_education_progress, id_family, component_name, score, index];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
  ...
  async deleteComponentScore(id_user: string, dto: any) {
    ...
    try {
      const query = 'SELECT * FROM f_delete_component_score($1, $2, $3, $4, $5)';
      const params = [id_user, id_subject, id_family, id_education_progress, index];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
  ...
  async modifyScore(id_user: string, dto: any) {
    ...
    try {
      ...
      const params = [id_user, id_subject, id_education_progress, id_family, midterm_score, final_score, bonus_score];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
  ...
  async removeScore(id_user: string, dto: any) {
    ...
    try {
      ...
      const params = [id_user, id_subject, id_education_progress, id_family, score_name];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
  ...
  async changeStatus(id_user: string, dto: any) {
    ...
    try {
      ...
      const params = [id_user, id_subject, id_education_progress, id_family, status];
      const data = await this.entityManager.query(query, params);
      return {
        message: 'Success',
